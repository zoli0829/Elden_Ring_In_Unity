...
namespace ZV
{
    public class SaveFileDataWriter 
    {
        ...
        // BEFORE WE CREATE A NEW SAVE FILE, WE MUST CHECK IF ONE OF THIS CHARACTER SLOT ALREADY EXISTS (MAX 10 CHARACTER SLOTS)
        ...
        public CharacterSaveData LoadSaveFile()
        {
            ...
            if(File.Exists(loadPath))
            {
                ...
                {
                    Debug.LogError("File is blank: " +ex.Message);
                }
            }
