...
namespace ZV
{
    public class PlayerCamera : MonoBehaviour
    {
        ...
        [SerializeField] float maximumViewableAnge = 50;
        [SerializeField] float lockOnTargetFollowSpeed = 0.2f;
        [SerializeField] float setCameraHeightSpeed = 0.1f;
        ...
        private void HandleRotations()
        {
            ...
            else
            {
                ...
                // ROTATE UP AND DOWN ON THE VERTICAL MOVEMENT ON THE RIGHT JOYSTICK
        ...
        private void HandleCollisions()
        {
            ...
            // WE CHECK IF THERE IS AN OBJECT IN FRONT OF THE CAMERA (SEE ABOVE)
        ...
        public void HandleLocatingLockOnTargets()
        {
            ...
            float shortestDistanceOfRightTarget = Mathf.Infinity;  // WILL VE USED TO DETERMINE SHORTEST DISTANCE ON ONE AXIS TO THE RIGHT OF CURRENT TARGET (+)
            float shortestDistanceOfLeftTarget = -Mathf.Infinity;   // WILL VE USED TO DETERMINE SHORTEST DISTANCE ON ONE AXIS TO THE LEFT OF CURRENT TARGET (-)
            ...
            for(int i = 0; i < colliders.Length; i++)
            {
                ...
                if(lockOnTarget != null)
                {
                    ...
                    if(viewableAngle >= minimumViewableAngle && viewableAngle <= maximumViewableAnge)
                    {
                        RaycastHit hit;
