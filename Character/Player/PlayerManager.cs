...
namespace ZV
{
    public class PlayerManager : CharacterManager
    {
        ...
        protected override void Update()
        {
            ...
            // IF WE DON NOT OWN THIS GAMEOBJECT, WE DO NOT CONTROL OR EDIT IT
            if (!IsOwner)
                return;
        ...
        private void OnClientConnectedCallback(ulong clientID)
        {
            ...
            // WE ONLY NEED TO LOAD OTHER PLAYERS GEAR TO SYNC IT IF WE JOIN A GAME THATS ALREADY BEEN ACTIVE WITHOUT US BEING PRESENT
            if (!IsServer && IsOwner)
            {
