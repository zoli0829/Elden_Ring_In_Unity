...
namespace ZV
{
    public class PlayerEquipmentManager : CharacterEquipmentManager
    {
        ...
        public void SwitchRightWeapon()
        {
            ...
            // 1. Check if we have another weapon besides our main weapon, if we do, NEVER swap to unarmed, rotate betweem 1 and 2
            ...
            if(player.playerInventoryManager.rightHandWeaponIndex < 0 || player.playerInventoryManager.rightHandWeaponIndex > 2)
            {
                ...
                float weaponCount = 0;
                WeaponItem firstWeapon = null; // first weapon thats not unarmed
            ...
            {
                // IF THE NEXT POTENTIAL WEAPON DOES NOT EQUAL TO UNARMED WEAPON
