...
namespace ZV
{
    public class PlayerLocomotionManager : CharacterLocomotionManager
    {
        ...
        // VALUES WILL BE TAKEN FROM THE INPUT MANAGER
        ...
        public void HandleSprinting()
        {
            ...
            // IF WE ARE STATIONARY, SPRINTING IS FALSE
            else
            {
                player.playerNetworkManager.isSprinting.Value = false;
            }
        ...
        public void AttemptToPerformDodge()
        {
            ...
            if(moveAmount > 0)
            {
                rollDirection = PlayerCamera.instance.cameraObject.transform.forward * verticalMovement; // or * PlayerInputManager.instance.verticalInput
        ...
        public void AttemptToPerformJump()
        {
            ...
            // IF WE ARE ALREADY IN A JUMP, WE DO NOT WANT TO ALLOW A JUMP AGAIN UNTIL THE CURRENT JUMP FINISHES
            if (player.characterNetworkManager.isJumping.Value)
                return;
